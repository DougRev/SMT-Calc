namespace CalcData.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        State = c.String(),
                        Zips = c.Int(nullable: false),
                        CreatedUtc = c.DateTimeOffset(nullable: false, precision: 7),
                        ModifiedUtc = c.DateTimeOffset(nullable: false, precision: 7),
                        YearlySmashes = c.Int(nullable: false),
                        XferStation = c.Boolean(nullable: false),
                        DistanceBetweenClients = c.Int(nullable: false),
                        DistanceToLandfill = c.Int(nullable: false),
                        DistanceToHauler = c.Int(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Franchise", new[] { "FranchiseeId" });
